...
<div class="header-text text-center header-image-cleaning" style="padding-top:220px">
    <h2 style="font-size:35px;min-height:40px;color:white" id="text-shadow2"></h2>
  </div>
            ...
            <div clas="row">
                <div class="col-sm-7" style="padding:0;margin:0">
                    ...
                    <div class="startern-header-div" style="padding-top:30px">
                        ...
                        <h1 class="startern-header"><span >Cleaning Service</span> </h1>
                ...
                <form method="post" action="{{ url('/all/service/add') }}">
                  ...
                  <select class="form-control" id="sel1" name="selected_service_area">
                    ...
                    @foreach ($cleaning_area as $cleaning)
                      <option value="{{ $cleaning->id }}">{{ $cleaning->sub_ser_area }}</option>
                    @endforeach
                  </select>
                </div>
                  <div class="form-group">
                      <select class="form-control" id="sel1" name="selected_sub_service">
                        ...
                        @foreach ($cleaning_info as $cleaning)
                          <option value="{{ $cleaning->id }}">{{ $cleaning->sub_service }}</option>
                        @endforeach
                      </select>
                    </div>
                    <div class="form-group">
